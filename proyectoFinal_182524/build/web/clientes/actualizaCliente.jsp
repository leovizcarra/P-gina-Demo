<%-- 
    ...
    Created on : 12/07/2021, 03:49:30 PM
    Author     : Leo
--%>
...
<html>
    ...
    <body>
        ...
        <article>
            <form action="../actualizaCliente" method="POST" autocomplete="off">
                <table border="1">
                    <tr>
                        <td>No. Credencial</td>
                        <td>
                    ...
                    <tr>
                        <td>Nombre</td>
                        <td><input name="nombre" value="<c:out value="${cliente.nombre}" />" maxlength="35" />
                        </td>
                    </tr>
                    <tr>
                        <td>Dirección</td>
                        <td><input name="direccion" value="<c:out value="${cliente.direccion}" />" maxlength="35" />
                        </td>
                    </tr>
                    <tr>
                        <td>Teléfono</td>
                        <td><input name="telefono" value="<c:out value="${cliente.telefono}" />" maxlength="10" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
