...
public class BuscarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Cliente cliente = clienteDao.buscarClientes(numCredencial);
            ...
            switch (accion) {
                case "Eliminar":
                    response.sendRedirect("clientes/eliminaCliente.jsp");
                    break;
                case "Actualizar":
                    response.sendRedirect("clientes/actualizaCliente.jsp");
                    break;
            }
