...
public class ListarInventario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Inventario> listaInventario = inventario.listarInventario();

            HttpSession session = request.getSession();
            session.setAttribute("lista", listaInventario);
            response.sendRedirect("inventario/listadoInventario.jsp");
